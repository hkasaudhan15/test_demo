...
public sealed class UpdateTenantSubscriptionCommandHandler : ICommandHandler<UpdateTenantSubscriptionCommand>
{
    private readonly ITenantRepository _tenantRepository;
    private readonly IUnitOfWork _unitOfWork;

    public UpdateTenantSubscriptionCommandHandler(ITenantRepository tenantRepository, IUnitOfWork unitOfWork)
    {
    ...
    public async Task<Result> Handle(UpdateTenantSubscriptionCommand request, CancellationToken cancellationToken)
    {
        ...
        tenant.ChangeSubscription(request.NewTier, request.ExpiresOnUtc);
